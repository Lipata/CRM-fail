            ...
            <div className={classes("row-layout filters-and-sorting")}>
              <div className={classes("row-layout group_3")}>
                <IgrSelect outlined={false} value={value} change={(_c, e) => setValue(e.detail.value)} className={classes("user-input")}>
                  <IgrSelectItem value="1" key="6c550b97-0193-4f21-bcca-612272ff4642">
                    <span key={uuid()}>My Accounts</span>
                  </IgrSelectItem>
                  <IgrSelectItem value="2" key="25f9aa38-5663-4675-81be-0ce846fc5cb7">
              ...
              <IgrSelect outlined={true} value={value1} change={(_c, e) => setValue1(e.detail.value)} className={classes("user-input")}>
                <IgrSelectItem value="1" key="eb535e39-abd1-4848-bfb8-c30eca948223">
                  <span key={uuid()}>Recently updated</span>
                </IgrSelectItem>
                <IgrSelectItem value="2" key="2a4112d9-c3ef-4b81-9641-11d773306951">
                  <span key={uuid()}>Name</span>
                </IgrSelectItem>
              </IgrSelect>
            </div>
            <IgrGrid data={grid_Data_Request?.items} primaryKey="customerId" rowSelection="single" rowEditable={true} pagingMode="Remote" allowFiltering={true} filterMode="excelStyleFilter" rowAdded={rowAddedGrid} rowSelectionChanging={(_c, e) => setSelectedCustomer(e.detail.newSelection[0])} rowDeleted={rowDeletedGrid} rowEditDone={rowEditDoneGrid} className={classes("ig-typography ig-scrollbar grid")} key={uuid()}>
              <IgrGridToolbar>
              ...
              <IgrPaginator perPage={grid_Page_Size} totalRecords={grid_Data_Request?.totalRecordsCount} page={grid_Page_Index} pageChange={(_c, e) => setGrid_Page_Index(e.detail)} perPageChange={(_c, e) => setGrid_Page_Size(e.detail)}></IgrPaginator>
        ...
        <IgrDialog closeOnOutsideClick={true} ref={newAccountDialog}>
          ...
          <form onSubmit={submitCustomerDto} ref={form} className={classes("column-layout form")} key={uuid()}>
            <div className={classes("column-layout form_fields")}>
              <IgrInput label="Company name" required outlined={true} name="companyName">
                <p slot="value-missing" key={uuid()}>This field is required</p>
              </IgrInput>
              <IgrInput label="Country" required outlined={true} name="address.country">
                <p slot="value-missing" key={uuid()}>This field is required</p>
              </IgrInput>
          ...
          <div slot="footer" key={uuid()}>
            ...
            <IgrButton type="submit" onClick={onClickButton2} className={classes("button_1")} key={uuid()}>
